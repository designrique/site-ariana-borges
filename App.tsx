...
const App: React.FC = () => {
  return (
    <main className="min-h-screen bg-brand-beige overflow-x-hidden selection:bg-brand-lilac selection:text-brand-dark">
      {/* Navigation Placeholder - Simplified for Landing Page focus */}
      <nav className="fixed top-0 w-full z-40 bg-white/80 backdrop-blur-md border-b border-gray-100 h-16 flex items-center transition-all duration-300">
        <div className="max-w-6xl mx-auto px-6 w-full flex justify-between items-center">
            ...
            <button className="hidden md:block bg-brand-dark text-white font-sans px-5 py-2 rounded-full text-xs font-bold hover:bg-brand-gold hover:scale-105 transition-all duration-300 shadow-md hover:shadow-lg">
                INSCRICOES ABERTAS
            </button>
        </div>
      </nav>
      ...
      <ScrollReveal>
        <section className="py-24 bg-brand-lilac/30 text-center relative overflow-hidden">
          ...
          <div className="max-w-4xl mx-auto px-6">
            ...
            <button className="bg-brand-lilacDark hover:bg-brand-gold text-white font-sans font-bold py-5 px-10 rounded-full shadow-xl hover:shadow-2xl transition-all duration-300 text-lg transform hover:-translate-y-1 hover:scale-105">
