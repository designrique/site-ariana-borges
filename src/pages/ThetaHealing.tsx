                ...
                <section className="py-16 bg-brand-beige">
                    <div className="max-w-6xl mx-auto px-6">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-5xl mx-auto">
                            ...
                            >
                                <div className="text-brand-lilacDark bg-brand-lilac/10 w-16 h-16 rounded-full flex items-center justify-center shrink-0">
                                    <UserTick size={32} variant="Linear" color="currentColor" />
                                </div>
                                <div>
                            ...
                            <Link
                                ...
                                className="group bg-white p-6 rounded-2xl shadow-sm hover:shadow-lg transition-all duration-300 flex items-center gap-4"
                            >
                                <div className="text-brand-gold bg-brand-gold/10 w-16 h-16 rounded-full flex items-center justify-center shrink-0">
                                    <Teacher size={32} variant="Linear" color="currentColor" />
                                </div>
                                <div>
